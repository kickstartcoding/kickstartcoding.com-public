...
window.moduloBuild.modules["x1r2j6ir"] = function library1_PlanMenu_script (modulo) {
...
return {"prepareCallback": typeof prepareCallback !== "undefined" ? prepareCallback : undefined, setLocalVariables: function (o) {props=o.props; staticdata_full_plans=o.staticdata_full_plans; staticdata_short_list=o.staticdata_short_list}, exports: script.exports }

};
window.moduloBuild.nameToHash.library1_PlanMenu_script = "x1r2j6ir";
...
window.moduloBuild.modules["xxe7h334"] = function library_Page_template (modulo) {
...
window.moduloBuild.nameToHash.library_Page_template = "xxe7h334";
...
window.moduloBuild.modules["xx4fuq6i"] = function library1_PlanMenu_template_regular (modulo) {
return function (CTX, G) { var OUT=[];
...
window.moduloBuild.nameToHash.library1_PlanMenu_template_solo = "x1nmrbok";

window.moduloBuild.modules["x1je2gfm"] = function library1_PlanMenu_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n        ");
  if (CTX.props.short) {
  OUT.push("\n            ");
...
window.moduloBuild.nameToHash.library1_PlanMenu_template = "x1je2gfm";
...
library1_PlanMenu_staticdata_short_list: {"Parent":"library1_PlanMenu","DefName":null,"Content":"/* JSON data, but evaluated as a JS expression */\n\n/* NOTE: Currently disabled */\n/*[\n    {\n        title: 'Virtual Bootcamp',\n        lectures: 'Prerecorded',\n        crossedPrice: '$186',\n        price: 99,\n        length: 'LIFETIME UPDATES',\n        summary: `Our classic bootcamp experience, now as a self-paced,\n        offline-friendly coding bootcamp!`,\n    },\n]*/\n\n[]\n","Type":"StaticData","DefLoaders":["DefTarget","DefinedAs","DataType","Src"],"DefBuilders":["ContentCSV","ContentTXT","ContentJSON","ContentJS","Code","RequireData"],"Name":"staticdata_short_list","DefinitionName":"library1_PlanMenu_staticdata_short_list","Source":"http://127.0.0.1:6627/static/libraries/shop/PlanMenu-short.js","data":[]}, 

library1_PlanMenu_script: {"Parent":"library1_PlanMenu","DefName":null,"Type":"Script","lifecycle":null,"DefBuilders":["Content|AutoExport","Code"],"Name":"script","DefinitionName":"library1_PlanMenu_script","Directives":[]}, 
