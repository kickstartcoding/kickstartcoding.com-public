...
window.moduloBuild.modules["xx7g1njh"] = function library_CourseList_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("<!DOCTYPE html>\n<html lang=\"en\">\n<head>\n<meta charset=\"utf-8\">\n<title>Error</title>\n</head>\n<body>\n<pre>Cannot GET /static/libraries/layout/CourseList.html</pre>\n</body>\n</html>\n"); // "<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"utf-8\"><title>Error</title></head><body><pre>Cannot GET /static/libraries/layout/CourseList.html</pre></body></html>"
...
window.moduloBuild.modules["xx2s0l4j"] = function library_Page_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("<head>\n    <title>"); // "<head><title>"
  ...
  OUT.push("\n        </ul>\n        <div class=\"right-links\" style=\"grid-column: 3\">\n            <a href=\"https://kickstartcoding.online/\">Student Portal &raquo;</a>\n        </div>\n    </nav>\n\n    <div class=\"Page-navHBMenu\">\n        <a href=\"#nav\" class=\"btn-hbmenu\">☰</a>\n    </div>\n\n    <a name=\"c\"></a> <!-- c = content -->\n    <slot class=\"Page-container layout-container\">\n    </slot>\n\n    <footer class=\"Page-footer\">\n        &copy; "); // "</ul><div class=\"right-links\" style=\"grid-column: 3\"><a href=\"https://kickstartcoding.online/\">Student Portal &raquo;</a></div></nav><div class=\"Page-navHBMenu\"><a href=\"#nav\" class=\"btn-hbmenu\">☰</a></div><a name=\"c\"></a><!-- c = content --><slot class=\"Page-container layout-container\"></slot><footer class=\"Page-footer\"> &copy;"
...
window.moduloBuild.nameToHash = {
 ...
 "library_Page_template": "xx2s0l4j",
 "library_CourseList_template": "xx7g1njh",
