...
window.moduloBuild.modules["x1jqk40b"] = function library1_Courses_staticdata (modulo) {
...
window.moduloBuild.modules["x1ib43mi"] = function library1_Courses_template (modulo) {
return function (CTX, G) { var OUT=[];
  ...
  OUT.push("\n                        <span class=\"sticky-note\">\n                            <span class=\"sticky-note-arrow\">⬆</span>\n                            <strong>Free Course for Beginners!</strong>\n                        </span>\n                    "); // "<span class=\"sticky-note\"><span class=\"sticky-note-arrow\">⬆</span><strong>Free Course for Beginners!</strong></span>"
  } // "endif"
  OUT.push("\n\n                </p>\n            "); // "</p>"
...
window.moduloBuild.modules["xxhe1r29"] = function library1_PlanMenu_staticdata (modulo) {
return [{"title":"Videos & Self-Paced","online":"Online only","lectures":"Prerecorded","crossedPrice":"$284","price":149,"length":"2 months","summary":"For only $135, unlock lifetime access to entire video\n        curriculum for self-study.<br />\n        <span style=\"font-family: Raleway; background: var(--sunshine);line-height: 1.8\"><strong>New to Kickstart</strong> Discount</span><br />\n        For only $14, add 2 months of group review & Linux Lab!\n        <br /><em>(renews at $149 for 2 months)</em>","enrollInfo":"Enrollment: Start self-paced, pop into Office Hours when you get stuck."},{"title":"Private Tutoring","online":"Online only","lectures":"Prerecorded","price":499,"length":"2 months","summary":"Level up your skills by purchasing a 1:1 tutoring\n        program, affordably priced to renew every 2 months. Includes\n        video curriculum and all group tutoring and lab options as well.","enrollInfo":"Enrollment: Rolling enrollment, enroll now to get 1:1 help\n        immediately."},{"title":"Hybrid Bootcamp","mostPopular":true,"online":"In-person and/or online","lectures":"Prerecorded","price":2499,"length":"9 months","summary":"We guide a beginner or intermediate coder to job-ready status\n        in 9 months.  We combine 1:1 tutoring with on-site and Zoom cohort\n        sprint sessions and help you kickstart your career in tech.","enrollInfo":"Enrollment: Enroll now to start prep & save a spot in the\n        next cohort."},{"title":"Oakland Bootcamp","online":"In-person only","lectures":"Live, On-Site","crossedPrice":"$10,992","price":8499,"length":"9 month bundle","inquire":"Enrollment: Next cohort is likely only to be Q1 2024","summary":"Join us in Oakland for our live, on-site full stack\n        coding bootcamp. Bundle consists of five courses, and 1:1\n        tutoring plan."}];
};
window.moduloBuild.modules["xx6ac2aq"] = function library1_PlanMenu_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("\n"); // ""
  ...
  OUT.push(G.escapeText(G.filters["safe"](CTX.plan.summary))); // "plan.summary|safe"
  OUT.push("</p>\n        "); // "</p>"
  ...
  */ // "endcomment"
  ...
  OUT.push("\n        "); // ""
  if (CTX.plan.enrollInfo) { // "if plan.enrollInfo"
  OUT.push("\n            <p class=\"inquire\">"); // "<p class=\"inquire\">"
  OUT.push(G.escapeText(CTX.plan.enrollInfo)); // "plan.enrollInfo"
  OUT.push("</p>\n        "); // "</p>"
  } // "endif"
  OUT.push("\n    </article>\n"); // "</article>"
  } // "endfor"
...
window.moduloBuild.modules["xx3vugdv"] = function library_FeaturedArticles (modulo) {
        ...
        modulo.registry.utils.initClass(modulo, def, x_FeaturedArticles);
        window.customElements.define(def.TagName, x_FeaturedArticles);
        return x_FeaturedArticles;
    
};
window.moduloBuild.modules["xxedgb45"] = function library_FeaturedArticles_script (modulo) {
...
window.moduloBuild.modules["x1oq9nq1"] = function library_FeaturedArticles_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("<main>\n    "); // "<main>"
  ...
  OUT.push(G.escapeText(CTX.article.image)); // "article.image"
  OUT.push("\" />\n            <label>"); // "\" /><label>"
  OUT.push(G.escapeText(CTX.article.title)); // "article.title"
  OUT.push("</label>\n        </article>\n    "); // "</label></article>"
  } // "endfor"
  OUT.push("\n</main>\n\n\n"); // "</main>"
...
window.moduloBuild.modules["x1h5kdot"] = function library_FeaturedTestimonials_template (modulo) {
return function (CTX, G) { var OUT=[];
  OUT.push("<main>\n    "); // "<main>"
  ...
  OUT.push("\n                "); // ""
  if (CTX.testimonial.name) { // "if testimonial.name"
...
window.moduloBuild.modules["xxhibhb1"] = function library_Page_script (modulo) {
var script = { exports: {} }; 
...
window.moduloBuild.nameToHash = {
 ...
 "library_FeaturedArticles": "xx3vugdv",
 "library_Page_script": "xxhibhb1",
 "library_FeaturedArticles_script": "xxedgb45",
 "library1_PlanMenu": "x1o5eu4n",
 "library1_Courses": "x1tcfakf",
 "library1_Courses_script": "x1nug6fj",
 "library_Page_template": "xxiajf34",
 "library_FeaturedTestimonials_template": "x1h5kdot",
 "library_FeaturedTestimonials_staticdata": "xxbcstkp",
 "library_Testimonials_template": "x1h5kdot",
 "library_Testimonials_staticdata": "xxnr3p18",
 "library_FeaturedArticles_template": "x1oq9nq1",
 "library1_PlanMenu_template": "xx6ac2aq",
 "library1_PlanMenu_staticdata": "xxhe1r29",
 "library1_Courses_template": "x1ib43mi",
 "library1_Courses_staticdata": "x1jqk40b"
};
window.moduloBuild.definitions = {
 ...
 "library_FeaturedArticles": {
  ...
  "Name": "FeaturedArticles",
  "DefinitionName": "library_FeaturedArticles",
  "ChildrenNames": [
   "library_FeaturedArticles_template",
   "library_FeaturedArticles_state",
   "library_FeaturedArticles_script",
   "library_FeaturedArticles_style"
  ],
  "TagName": "x-featuredarticles"
 },
 "library_Page_props": {
  "Parent": "library_Page",
  "DefName": null,
 ...
 "library_FeaturedArticles_template": {
  "Parent": "library_FeaturedArticles",
  "DefName": null,
  "Type": "Template",
  "DefFinalizers": [
   "TemplatePrebuild"
  ...
  "Name": "template",
  "DefinitionName": "library_FeaturedArticles_template",
  "Source": "http://127.0.0.1:6627/static/libraries/layout/FeaturedArticles.html",
  "Hash": "Tx1oq9nq1"
 },
 "library_FeaturedArticles_state": {
  "Parent": "library_FeaturedArticles",
  ...
  "articles": [],
  "Name": "state",
  "DefinitionName": "library_FeaturedArticles_state"
 },
 "library_FeaturedArticles_script": {
  "Parent": "library_FeaturedArticles",
  "DefName": null,
  ...
  "Name": "script",
  "DefinitionName": "library_FeaturedArticles_script",
  "Directives": []
 },
 "library_FeaturedArticles_style": {
  "Parent": "library_FeaturedArticles",
  ...
  "Name": "style",
  "DefinitionName": "library_FeaturedArticles_style",
  "Source": "http://127.0.0.1:6627/static/libraries/layout/FeaturedArticles.css"
 },
 "library1_configuration": {
  "Parent": "library1",
  "DefName": null,
